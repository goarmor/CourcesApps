...
public class RepositoriesActivity extends AppCompatActivity implements RepositoriesView,
    ...
    public static RepositoriesActivity repositoriesActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppDelegate.getAppComponent().repositoriesComponent().injectPresenter(this);
